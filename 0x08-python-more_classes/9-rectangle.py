...
class Rectangle:
    ...
    __str__(self)
        Returns a string of print_symbol in rectangle shape
    __repr__(self)
        Returns a string of Class(attributes)
    __del__(self)
        Prints a message after deleting an instance of rectangle
    bigger_or_equal(rect_1, rect_2)
        returns which is bigger in area, defaults to 1 if equal
    square(cls, size=0)
        creates an instance of rectangle with square size
    Attributes
    ----------
    nummber_of_instances : int
        initialized as 0, keeps count of the instances of Rectangle
    print_symbol : any
        initialized as #, stores a variable to print rectangle shape
    """
    ...
    def square(cls, size=0):
        """A function to set the size of rectangle to square size"""
    ...
    def bigger_or_equal(rect_1, rect_2):
        """A function to compare the size of 2 rectangles"""
    ...
    def __str__(self):
        """A function to return the rectangle as print_symbol"""
